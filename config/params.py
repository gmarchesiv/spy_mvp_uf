...
class parameters:
    def __init__(self ):
        ...
        self.diamante_cr3  = [  self.umbral_manifestacion_cR3, 0.037    ] # DIAMANTE DE COMPRA
        self.resta_cr3  = [  0.0295,self.inf_n]# RETROCESO DEL DIAMANTE 
        # ==================================
        # =========== CALL - R1-E ========== 
        # ==================================
        ...
        # VENTA
        self.sl_cr1_fast =-0.035  # STOP LOSS
