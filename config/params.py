...
class parameters:
    def __init__(self ):
        ...
        self.dcall_r1_c =[-0.14, 0.11]
        self.docall_r1_c = [0.05, 0.11]
        self.timeCall_r1_c = [dt_time(11, 35), dt_time(12, 35)]
        ...
        self.timePut_r1_i = [dt_time(9, 40), dt_time(10,15)]
        ...
        self.resta_pr2_e = [ 0.005  ] # RETROCESO DEL DIAMANTE  
